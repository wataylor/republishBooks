/* emailAddressCheck.jsp

Java script to validate email addresses, alerts and returns false if
bad, otherwise returns true.
...
special characters.  We don't want to allow special characters in the
address.  These characters include ( ) < > @ , ; : \ " . [ ] */
...
alert("The e-mail address user name contains invalid characters.");
return false;
   }
}
...
alert("The name part of the e-mail address doesn't seem to be valid.");
return false;
}
